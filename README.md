...
You can visit for example **[picsocial-api-docs](https://tanas2k4.github.io/picsocial-api-docs/)**
...
```bash
dotnet swagger tofile --output swagger.json ./bin/Debug/net10.0/YourProject.dll v1
```
